...
EOF
    ...
    echo ""
    echo "=== Запустите Happ, введите ключ, настройте автозапуск при старте системы, автообновление подписки раз в 6 часов и автоподключение к последней локации, выберите и подключите желаемую локацию с лучшим пингом в PROXY-режиме и возвращайтесь в это окно. ==="
    echo ""
